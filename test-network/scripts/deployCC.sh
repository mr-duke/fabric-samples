...
CHANNEL_NAME=${1:-"evoting-channel"}
CC_NAME=${2}
CC_SRC_PATH=${3}
CC_SRC_LANGUAGE=${4}
CC_VERSION=${5:-"1.0"}
...
## expect org1 to have approved and org2 and org 3 not to
...
## check whether the chaincode definition is ready to be committed
## expect org1 and org2 to have approved and org 3 not to
...
## check whether the chaincode definition is ready to be committed
## expect all three organizations to have approved
